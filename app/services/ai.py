...
class AIService(ABC):
    ...
    def _has_hardcoded_suggested_responses(self, doctor_data):
        """Check if the doctor has hardcoded suggested responses configured"""
        ...
        logger.info(f"_has_hardcoded_suggested_responses: identifier={doctor_identifier}, has_config={has_config}")
        return has_config
...
"""
    ...
    def _has_hardcoded_suggested_responses(self, doctor_data):
        ...
        logger.info(f"_has_hardcoded_suggested_responses: identifier={doctor_identifier}, has_config={has_config}")
        return has_config
    async def generate_suggested_response(self, patient_summary: str, discharge_summary: str = None, doctor_data=None) -> str:
