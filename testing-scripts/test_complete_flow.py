...
def test_case_history(token, patient_id):
    ...
    try:
        ...
        if response.status_code == 404:
            ...
            # This data would be used to create a patient profile in a real test
            # patient_data = {
            #     "name": TEST_PATIENT_NAME,
            #     "dob": "1990-01-01",
            #     "gender": "male",
            ...
            # Use the patient signup endpoint to create a profile
            # Since we already have a user, we'll simulate having a profile
        ...
        update_data = {
            "summary": "Patient has fever and sore throat. Possible viral infection.",
            "documents": ["doc789", "doc012"]  # Example document IDs
        }
...
def test_reports(token, patient_id):
    ...
    try:
        ...
        update_data = {
            "title": "Updated Throat Culture Results",
            "description": "Negative for streptococcal infection"
        }
...
def main():
    """Main test function"""
    print("Starting complete flow test for POCA service...")
